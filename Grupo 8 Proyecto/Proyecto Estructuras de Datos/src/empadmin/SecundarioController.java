...
public class SecundarioController {
    ...
    public void llenarCheckBox(){
        ...
        cmb.getItems().addAll("Ninguno","Disparos","Multijugador","Fantasia","Estrategia","Deportes","Battle royale","Multiplataforma","Videojuego de rol","Accion");
    ...
    public void llenarCampos(NodoLista<Juego> j){
        busqueda.setPromptText("Buscar");
                if(j.length()==0){
                    ...
                    content.getChildren().addAll(nombre,categoriasJ); 
                    ...
                    content1.getChildren().addAll(nombre1,categoriasJ1); 
